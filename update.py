...
def hello():
    ...
    sql="UPDATE  student SET name=%s,stream=%s WHERE rollno=%s"
...
l1=Label(w,text="update record",font=('Arial',25)).place(x=150,y=20)
...
b1=Button(w,text="update",command=hello,height=2,width=20)
